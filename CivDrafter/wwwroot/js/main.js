			...
			_elm_community$random_extra$Random_List$shuffle(
				A2(
					...
					A2(
						_elm_lang$core$List$filter,
						function (l) {
							return _elm_lang$core$Native_Utils.eq(l.banned, false);
						},
						leaders))));
	});
...
var _user$project$Main$toggleBanned = F2(
	function (id, leaders) {
		var toggle = F2(
			function (i, leader) {
				return _elm_lang$core$Native_Utils.eq(i, leader.id) ? _elm_lang$core$Native_Utils.update(
					leader,
					{banned: !leader.banned}) : leader;
			});
		return A2(
			_elm_lang$core$List$map,
			toggle(id),
...
var _user$project$Main$renderSettingsButton = F3(
	function (selected, message, i) {
		return A2(
...
var _user$project$Main$renderDraftLeader = function (leader) {
	return A2(
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('image is-48x48'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															A2(_elm_lang$core$Basics_ops['++'], ' ', leader.civlization)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$Main$getLeaderById = F2(
	function (leaders, id) {
		var leader = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (le) {
					return _elm_lang$core$Native_Utils.eq(id, le.id);
				},
				leaders));
		var _p0 = leader;
		if (_p0.ctor === 'Nothing') {
...
var _user$project$Main$renderDraft = F3(
	function (leaders, players, draftResult) {
		var player = A2(
			_elm_lang$core$Maybe$withDefault,
			'Unknown',
			A2(_elm_community$list_extra$List_Extra$getAt, draftResult.playerNumber - 1, players));
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$List$map,
									_user$project$Main$renderDraftLeader,
									A2(
										_elm_lang$core$List$map,
										_user$project$Main$getLeaderById(leaders),
										draftResult.choices))),
							_1: {ctor: '[]'}
						}
					}),
...
var _user$project$Main$renderDrafts = F3(
	function (leaders, players, draftResults) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('columns is-parent has-text-centered'),
				_1: {ctor: '[]'}
			},
			function () {
				var _p1 = draftResults;
				if (_p1.ctor === 'Nothing') {
					return {ctor: '[]'};
				} else {
					return A2(
						_elm_lang$core$List$map,
						A2(_user$project$Main$renderDraft, leaders, players),
						_p1._0);
				}
			}());
	});
...
var _user$project$Main$getLeadersFromJson = function (json) {
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$leadersDecoder, json));
};
var _user$project$Main$Settings = F4(
	function (a, b, c, d) {
		return {numberOfPlayers: a, civsPerPlayer: b, maxNumberOfPlayers: c, maxNumberOfCivsPerPlayer: d};
	});
var _user$project$Main$DraftResult = F2(
	function (a, b) {
		return {playerNumber: a, choices: b};
	});
var _user$project$Main$createDraftForPlayer = F3(
	function (availableLeaders, civs, player) {
		return A2(
			_user$project$Main$DraftResult,
			player,
			A2(_elm_lang$core$List$take, civs, availableLeaders));
	});
var _user$project$Main$createDrafts = F2(
	function (settings, shuffledLeaders) {
		return _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$List$map,
				function (p) {
					return A3(
						_user$project$Main$createDraftForPlayer,
						A2(_elm_lang$core$List$drop, (p - 1) * settings.civsPerPlayer, shuffledLeaders),
						settings.civsPerPlayer,
						p);
				},
				A2(_elm_lang$core$List$range, 1, settings.numberOfPlayers)));
	});
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {settings: a, leaders: b, drafts: c, players: d};
	});
...
var _user$project$Main$SetCivsPerPlayer = function (a) {
	return {ctor: 'SetCivsPerPlayer', _0: a};
};
var _user$project$Main$SetPlayers = function (a) {
	return {ctor: 'SetPlayers', _0: a};
};
var _user$project$Main$renderSettings = function (settings) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$List$map,
										A2(_user$project$Main$renderSettingsButton, settings.numberOfPlayers, _user$project$Main$SetPlayers),
										A2(_elm_lang$core$List$range, 1, settings.maxNumberOfPlayers))),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Civs per player'),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										...
										A2(
											_elm_lang$core$List$map,
											A2(_user$project$Main$renderSettingsButton, settings.civsPerPlayer, _user$project$Main$SetCivsPerPlayer),
											A2(_elm_lang$core$List$range, 1, settings.maxNumberOfCivsPerPlayer))),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$ToggleBanned = function (a) {
	return {ctor: 'ToggleBanned', _0: a};
};
var _user$project$Main$renderLeader = function (leader) {
	var classString = A2(
		_elm_lang$core$Basics_ops['++'],
		'button',
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$ToggleBanned(leader.id)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Main$renderLeaderBanList = function (leaders) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		switch (_p2.ctor) {
			case 'Draft':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Main$shuffleLeaders, model.leaders, _user$project$Main$CreateDraft),
						_1: {ctor: '[]'}
					});
			case 'CreateDraft':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							drafts: A2(_user$project$Main$createDrafts, model.settings, _p2._0)
						}),
					{ctor: '[]'});
			case 'ToggleBanned':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							leaders: A2(_user$project$Main$toggleBanned, _p2._0, model.leaders)
						}),
					{ctor: '[]'});
			case 'SetPlayers':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							settings: A2(_user$project$Main$setPlayers, model.settings, _p2._0),
							drafts: _elm_lang$core$Maybe$Nothing
						}),
					{ctor: '[]'});
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							settings: A2(_user$project$Main$setCivsPerPlayer, model.settings, _p2._0),
							drafts: _elm_lang$core$Maybe$Nothing
						}),
					{ctor: '[]'});
		}
	});
var _user$project$Main$Draft = {ctor: 'Draft'};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Robin\'s Civ drafter'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$renderSettings(model.settings),
				_1: {
					ctor: '::',
					_0: _user$project$Main$renderLeaderBanList(model.leaders),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$renderDrafts, model.leaders, model.players, model.drafts),
							_1: {ctor: '[]'}
						}
					}
				}
